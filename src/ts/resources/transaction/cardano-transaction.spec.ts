...
import { CardanoSignData, CardanoTransactionCreatedWebhookMessage } from "../../types";
...
describe("Cardano Transaction", () => {
  describe("Payment Transaction", () => {
    ...
    before("Setup Tests", () => {
      const transaction: CardanoSignData["data"] = {
        inputs: [
          {
            index: "0x1",
          ...
          delegateSignData: [
            {
              ...
              unverifiedDigestData: {
                digest: "6283d3e652fff925a1af096b4bcaf153e1bf19b88da8d00c518c7f8596187e97",
                signData:
    ...
    it("Should construct the correct digest for a payment transaction", () => {
      ...
      const { digest } = validPaymentTxn.signData.delegateSignData[0].unverifiedDigestData;

      expect(transaction.constructExpectedDigest().toString("hex")).to.equal(digest);
    });
  ...
  describe("Staking Transaction", () => {
          ...
          delegateSignData: [
            {
              ...
              unverifiedDigestData: {
                digest: "7e6369d7ca8b3150dd734bc814ef3e5585c851defb979ee7b18fc923533e74a0",
                signData:
    ...
    it("Should construct the correct digest for a staking transaction", () => {
      ...
      const { digest } = validStakingTxn.signData.delegateSignData[0].unverifiedDigestData;
  ...
  describe("Unstaking Transaction", () => {
          ...
          delegateSignData: [
            {
              ...
              hdWalletPath: ["0x8000073c", "0x80000717", "0x80000000", "0x80000002", "0x80000000"],
              unverifiedDigestData: {
                digest: "047647047ab9d2d8daf99e97ca163bc5120289a7bb9963a7af15231a9e292475",
                signData:
    ...
    it("Should construct the correct digest for a unstaking transaction", () => {
      ...
      const { digest } = validUnstakingTxn.signData.delegateSignData[0].unverifiedDigestData;
  ...
  describe("Withdrawal Transaction", () => {
          ...
          delegateSignData: [
            {
              ...
              algorithm: "0x01",
              unverifiedDigestData: {
                digest: "bc334ab55946df49b30f76b5926776c5706f598e6427b1b0411d3a0fd7de8355",
                signData:
    ...
    it("Should construct the correct digest for a withdrawal transaction", () => {
      ...
      const { digest } = validWithdrawalTxn.signData.delegateSignData[0].unverifiedDigestData;
